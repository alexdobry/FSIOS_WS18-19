...
class PhotosCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout, UIViewControllerPreviewingDelegate, PhotoCollectionViewCellDelegate {
    ...
    @IBOutlet weak var reduceItemsButton: UIBarButtonItem!
    @IBOutlet weak var increaseItemsButton: UIBarButtonItem!
...
//        return section == 0 ? model.count : 0
    ...
    @IBAction func zoomIn(_ sender: UIBarButtonItem){
        if(itemsInLine > 1 && !isEditing){
            itemsInLine -= 1
            print("decreased items per line to \(itemsInLine)")
        }
    ...
    @IBAction func zoomOut(_ sender: UIBarButtonItem){
        ...
        if(itemsInLine < 6 && !isEditing){
            itemsInLine += 1
            print("increased items per line to \(itemsInLine)")
