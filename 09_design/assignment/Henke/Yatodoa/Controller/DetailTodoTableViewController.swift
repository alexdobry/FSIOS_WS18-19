...
class DetailTodoTableViewController: UITableViewController {
    ...
    @objc func deleteTodo() {
        ...
        if let nav = splitViewController?.children.first as? UINavigationController {
    ...
    private func updateTagsLabel() {
        let tags = todo.joinedTagTitles
        tagLabel.text = tags.isEmpty ? nil : tags.joined(separator: ", ")
    }
}
