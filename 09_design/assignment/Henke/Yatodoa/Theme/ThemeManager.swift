...
fileprivate extension Theme {
    var tintColor: UIColor {
        ...
        case .bright: return #colorLiteral(red: 0.1411764706, green: 0.1490196078, blue: 0.2078431373, alpha: 1)
    ...
    var navigationBarTextColor: UIColor {
        ...
        case .bright: return #colorLiteral(red: 1, green: 0.9349854589, blue: 0.9646770358, alpha: 1)
    ...
    var positiveColor: UIColor? {
        ...
        case .bright: return #colorLiteral(red: 1, green: 0.3148484528, blue: 0.6811948419, alpha: 1)
        }
    }
    ...
    var secondaryTextColor: UIColor? {
        ...
        case .bright: return #colorLiteral(red: 1, green: 0.08327253908, blue: 0.4573590159, alpha: 1)
        }
    }
    ...
    var checkboxStyle: CheckboxStyle {
        ...
        case .bright: return CheckboxStyle(checkmarkColor: tintColor, borderColor: #colorLiteral(red: 1, green: 0.3148484528, blue: 0.6811948419, alpha: 1))
        }
    }
...
final class ThemeManager {
    ...
    private static func apply(_ theme: Theme) {
       ...
       // UIView.appearance().backgroundColor = theme.backgroundColorContent
